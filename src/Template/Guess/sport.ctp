...
<div class="sectionInfo">
    <div class='main_image' style='background-image: url("<?=$this->element('imageSrcMainImage', ['path'=>"/img/sports/basketball.png"])?>");' onclick="openImageZoom('/img/sports/basketball.png')"></div>
    <div class='details'>
		<p>
